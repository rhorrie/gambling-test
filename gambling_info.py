...
def	get_records(full_team_array, current_day_team_array, scores):			#This function turns the current day team array into games(H,A,Home Score, Away Score) and then also assigns the correct records to teams.
